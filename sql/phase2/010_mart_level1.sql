-- -- sql/phase2/010_mart_level1.sql (FINAL CORRECTED VERSION)
...
--   GROUP BY 1
-- )
-- -- FIX: Use lowercase, unquoted identifiers to match the test script's expectations.
-- -- The python script will re-alias these to "Title Case" for the final CSV output.
-- SELECT
--   u.sku_id,
--   u.account_number,
